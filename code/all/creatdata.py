...
for i in range(0,100):
    ...
    customer_id="C"+str(np.random.randint(1,1000)).zfill(5)
    ...
    sales0=sales0.append(
        pd.Series(
            [date,customer_id,sales_person,
            region,product,price,quantity,revenue],
            index=sales0.columns
        ),ignore_index=True
    )
sales0.to_hdf('sales.h5',key='sales')
